...
date: "2021-06-10"
description: "Automate code quality checks with Git hooks. Learn how to run linters, tests, and formatters pre-commit—without relying on external tools like Husky."
...
> `git add . git commit -m "skip git hooks" —-no-verify`
